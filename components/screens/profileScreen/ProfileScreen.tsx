...
import { User, Wallet, LogOut, ChevronRight, Edit2, Check } from 'lucide-react-native';
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
        ...
        <View className="px-6 mb-6">
          <View className="bg-card rounded-2xl p-6 border border-border items-center">
            ...
            <Text className="text-xl font-bold text-foreground mb-1">Chinedu Okonkwo</Text>
            <Text className="text-sm text-muted-foreground mb-4">chinedu.okonkwo@email.com</Text>
            
            <View className="flex-row gap-3 mt-2">
              <View className="bg-emerald-50 dark:bg-emerald-900/20 px-4 py-2 rounded-full">
                <Text className="text-xs font-medium text-emerald-700 dark:text-emerald-300">Premium User</Text>
              </View>
            </View>
          </View>
        </View>
            ...
            <View className="p-4 flex-row items-center justify-between border-b border-border">
              <View className="flex-row items-center gap-3">
                ...
                <View>
                  ...
                  <Text className="text-xs text-muted-foreground">Dark mode enabled</Text>
                </View>
              </View>
            </View>
            ...
            <TouchableOpacity className="p-4 flex-row items-center justify-between">
              <View className="flex-row items-center gap-3">
                ...
                <View>
                  ...
                  <Text className="text-xs text-muted-foreground">Manage alerts</Text>
                </View>
              </View>
            ...
            <TouchableOpacity className="p-4 flex-row items-center justify-between">
              <View className="flex-row items-center gap-3">
                ...
                <View>
                  ...
                  <Text className="text-xs text-muted-foreground">Get assistance</Text>
                </View>
              </View>
              <ChevronRight size={20} className="text-muted-foreground" />
            </TouchableOpacity>
        ...
        <View className="items-center mt-8 mb-4">
          <Text className="text-xs text-muted-foreground">MoneyTrack v1.0.0</Text>
        </View>
